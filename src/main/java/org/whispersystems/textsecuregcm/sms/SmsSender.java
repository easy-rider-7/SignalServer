...
public class SmsSender {
  ...
  static final String SMS_IOS_VERIFICATION_TEXT = "Your SecureTalk verification code: %s\n\nOr tap: stlk://verify/%s";
  static final String SMS_VERIFICATION_TEXT     = "Your SecureTalk verification code: %s";
  static final String VOX_VERIFICATION_TEXT     = "Your SecureTalk verification code is: ";
